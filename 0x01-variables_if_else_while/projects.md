# `01. C - Variables, if, else, while`
## `C` 
```
By: Julien Barbier
Weight: 1
Project over - took place from Mar 11, 2022 6:00 AM to Mar 12, 2022 6:00 AM
An auto review will be launched at the deadline
In a nutshell…
Auto QA review: 67.9/70 mandatory & 13.65/21 optional
Altogether:  160.05%
Mandatory: 97.0%
Optional: 65.0%
Calculation:  97.0% + (97.0% * 65.0%)  == 160.05%
```
